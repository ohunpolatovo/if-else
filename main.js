...
//let A = +prompt("juft son kiriting");
//if (A % 2 === 0) {console.log("ha bu juft son");}
...
//if (A >= 0 || B < -2) {console.log("ha butun son");}
...
//let B = +prompt("b sonini kiriting");
//if (A % 2 !== 0 && B % 2 !== 0) {console.log("a va b sonlari toq sonlar ");}
//else {console.log("a va b sonlari toq son emas");}
//============================================
...
//let son = +prompt("ikki xonali son kiriting");if (son >= 10 && son <= 99 && son % 2 === 0) {
